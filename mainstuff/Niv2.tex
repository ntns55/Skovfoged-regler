...
\input{mainstuff/Evner/Påfør gift}
\input{mainstuff/Evner/Minearbejder}
\subsection*{Samler}\addcontentsline{toc}{subsection}{Samler}
...
\input{mainstuff/Evner/Urtesamler}