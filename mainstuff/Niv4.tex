...
\addcontentsline{toc}{section}{Evne beskrivelse for Skovrider}

\input{mainstuff/Evner/Ekstra LP Niv. 3}

\subsection*{Naturens Klinge}\addcontentsline{toc}{subsection}{Naturens Klinge}
...
\subsection*{Rune Kendskab}\addcontentsline{toc}{subsection}{Rune Kendskab}
...
\addcontentsline{toc}{section}{Evne beskrivelse for Naturforvalter}

\subsection*{Alt er et}\addcontentsline{toc}{subsection}{Alt er et}
...
\subsection*{Naturlig Oase}\addcontentsline{toc}{subsection}{Naturlig Oase}
...
\input{mainstuff/Evner/Urteudvalg}